...
pg = st.navigation({
    ...
    "Week 2: チャットUI、セッションステート": [
        ...
        # st.Page("pages/11_.py", title="Day 11: xxx", icon=":material/cached:"),
        # st.Page("pages/12_.py", title="Day 12: xxx", icon=":material/question:"),
        # st.Page("pages/13_.py", title="Day 13: xxx", icon=":material/cached:"),
        # st.Page("pages/14_.py", title="Day 14: xxx", icon=":material/cached:"),
    ],
    "Week 3: RAGアプリ": [
